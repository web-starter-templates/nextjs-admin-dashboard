...
import { claimRow } from '@/helpers/api-utils';
import { useAppointments } from '@/contexts/AppointmentsContext';

interface AvailableRoutesTableProps {
  className?: string;
...
const AvailableRoutesTable: FC<AvailableRoutesTableProps> = ({ appointments }) => {
  ...
  const claimAppointment = async (appointment: AppointmentView) => {
    setLoading(true)
    claimRow(user, token, appointment).then( (data) => {setLoading(false);updateAppointments(data)})
  }
            ...
            {paginatedCryptoOrders.map((cryptoOrder: AppointmentView) => {
              ...
              return (
                ...
                >
                  ...
                  <TableCell align="right">
                  { !loading && 
                    <Tooltip title="Claim Route" arrow onClick={() => claimAppointment(cryptoOrder)}>
                      <IconButton
                        sx={{
                          '&:hover': {
...
AvailableRoutesTable.propTypes = {
  appointments: PropTypes.array.isRequired
};

AvailableRoutesTable.defaultProps = {
  appointments: []
};

export default AvailableRoutesTable;
